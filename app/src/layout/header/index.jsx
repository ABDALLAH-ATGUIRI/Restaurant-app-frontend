...
function Header() {
  ...
  return (
    <div className='mx-auto w-full flex justify-between items-center p-4 px-8'>
      { }
      <div className=" w-1/6 ml-10 flex p-2 justify-between  items-center ">

        <img
          src={Logo}
          className={`cursor-pointer duration-500 w-48 pr-4`}
        />
