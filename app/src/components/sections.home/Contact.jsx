    ...
    return (
        <Fragment>
                <div className='w-full h-full grid grid-cols-5 px-20 bg-white py-16'>
                    <div class="w-full h-5/6 left-0 top-0 flex flex-col col-span-3 text-gray-700 justify-center items-start">
                        <div class="h-full w-full px-4 mx-auto max-w-screen-md">
